...
<?php
    ...
    $posts = buscar(
        ...
        [
            ...
            '(select nome
                from usuario
                whwre usuario.id = post.uusuario_id) as nome'               
        ],
        [
            ['id', '=', $post]
        ]
...
<html>
    <head>
        ...
        <link rel="stylesheet"
                href="lib/bootstrap-4.2.2-dist/css/bootstrap.min.css">
    </head>
    <body>
        <div class="container">
            <div class="row">
        ...
        <script src='lib/bootstrap-4.2.2-dist/js/bootstrap.min.js"></script>
    </body>
</html>