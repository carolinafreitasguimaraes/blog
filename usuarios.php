...
<html>
<head>
    <!-- Título da página (deve ser preenchido com um título apropriado) -->
    <title></title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                // Inclusão do arquivo valida_login.php para validar o login do usuário.
                include 'includes/valida_login.php';
                
                // Verificação se o usuário possui privilégios de administrador.
        ...
        <div class="row" style="min-height: 500px;">
            ...
            <div class="col-md-12" style="padding-top: 50px;">
                <?php 
                // Inclusão do arquivo busca.php para exibir uma barra de busca.
                include 'includes/busca.php'; 
                ?>
                <?php
                // Inclusão de arquivos e processamento de dados
